...
const BankCard = ({ field, index }) => (
  <motion.div
    variants={fadeUp}
    custom={index}
    whileHover={{ scale: 1.01, boxShadow: "0 4px 24px 0 rgba(99,102,241,0.15)" }}
    style={{
      display: "flex",
      alignItems: "center",
    ...
    >
      ...
      <div style={{ padding: "32px 32px 28px" }}>
        ...
        >
          ...
          <InfoRow label="Comment"        value={transfer?.comment}        index={4} />
        </motion.div>
        ...
        <motion.button
          ...
          whileHover={!loading && status !== "completed" ? { scale: 1.02, boxShadow: "0 8px 32px 0 rgba(99,102,241,0.4)" } : {}}
